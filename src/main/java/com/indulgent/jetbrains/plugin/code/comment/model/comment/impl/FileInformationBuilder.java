 ...
 *         06.06.2016.
 */
interface FileInformationBuilder {
	/**
	 ...
	 */
	@NotNull
	FileInformation build(@NotNull Project project, @NotNull VirtualFile file) throws EmptyFileCanonicalPathException, EmptyProjectPathException, FileNotInProjectException;
}
